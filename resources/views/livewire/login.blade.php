   ...
   <div class="w-full flex h-full">
        ...
        <div class="flex-1 flex items-center justify-center">
            <form class="flex flex-col w-full px-5">
                <label>Login</label>
                <input class="border-2 mb-5 p-2 outline-none rounded-md border-gray-300" type="text">
                <label>Senha</label>
                <input class="border-2 p-2 outline-none rounded-md border-gray-300" type="password">
